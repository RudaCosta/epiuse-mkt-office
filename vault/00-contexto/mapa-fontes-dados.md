...
| **Field Marketing** (92 eventos) | `/field-marketing` | events.json + `field_events` SQLite | 🟡 PARCIAL | eventos reais; captura (leads/deals/custo) VAZIA — aguarda preenchimento pós-evento pelo Field |
