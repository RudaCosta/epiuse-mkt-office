...
7. **Persistência**: aceito o risco do SQLite sem volume COM mitigação (backup/restore por editor token) + pendência humana escalada (montar Railway Volume). Não usar serviço externo pra isso.
