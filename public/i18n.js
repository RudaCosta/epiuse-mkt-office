...
window.OFFICE_PHRASES = {
  ...
  // ── North-star + KPIs (home.js) ──
  'Pipeline MKT · FY': { en: 'MKT Pipeline · FY', es: 'Pipeline MKT · FY' },
  'Seguidores LinkedIn': { en: 'LinkedIn Followers', es: 'Seguidores LinkedIn' },
  'Novos no mês': { en: 'New this month', es: 'Nuevos en el mes' },
  'DDF aprovado válido': { en: 'Valid approved DDF', es: 'DDF aprobado válido' },
  'Posts esta semana': { en: 'Posts this week', es: 'Posts esta semana' },
  'Conteúdos aguardando': { en: 'Content pending', es: 'Contenidos pendientes' },
  'Voices ativos': { en: 'Active Voices', es: 'Voices activos' },
  'Contatos Apollo': { en: 'Apollo contacts', es: 'Contactos Apollo' },
  'Sequências ativas': { en: 'Active sequences', es: 'Secuencias activas' },
  'Usuários site (mês)': { en: 'Site users (month)', es: 'Usuarios sitio (mes)' },
  'Eventos 30 dias': { en: 'Events 30 days', es: 'Eventos 30 días' },
  'Capturas a preencher': { en: 'Captures to fill', es: 'Capturas por completar' },
  'Claims DF a reclamar': { en: 'DF claims to file', es: 'Claims DF por reclamar' },
  'Go-lives SAP 30d': { en: 'SAP go-lives 30d', es: 'Go-lives SAP 30d' },
  'Projetos SAP Live': { en: 'SAP Live projects', es: 'Proyectos SAP Live' },
  'Cases publicados': { en: 'Published cases', es: 'Casos publicados' },
  // ── Digest / Hoje / Agenda (home.js) ──
  'na agenda': { en: 'on the agenda', es: 'en la agenda' },
  'sem eventos esta semana': { en: 'no events this week', es: 'sin eventos esta semana' },
  'ver Alertas & Bloqueios ↓': { en: 'see Alerts & Blockers ↓', es: 'ver Alertas y Bloqueos ↓' },
  'programa MVP em curso': { en: 'MVP program ongoing', es: 'programa MVP en curso' },
  '🎉 Sem bloqueios ativos.': { en: '🎉 No active blockers.', es: '🎉 Sin bloqueos activos.' },
  'Sem bloqueios ativos.': { en: 'No active blockers.', es: 'Sin bloqueos activos.' },
  'Falha ao carregar agenda': { en: 'Failed to load agenda', es: 'Error al cargar la agenda' },
  'Nada agendado pra hoje. ✨': { en: 'Nothing scheduled today. ✨', es: 'Nada agendado para hoy. ✨' },
  'Sem metas com valor real ainda.': { en: 'No goals with real value yet.', es: 'Aún no hay metas con valor real.' },
  'Erro ao carregar digest.': { en: 'Failed to load digest.', es: 'Error al cargar el resumen.' },
  'Erro ao carregar áreas.': { en: 'Failed to load areas.', es: 'Error al cargar las áreas.' },
  'Erro ao carregar alertas.': { en: 'Failed to load alerts.', es: 'Error al cargar las alertas.' },
  'itens': { en: 'items', es: 'ítems' },
  'item': { en: 'item', es: 'ítem' },
  'vista compacta': { en: 'compact view', es: 'vista compacta' },
  'vista anual': { en: 'annual view', es: 'vista anual' },
  // ── Tabs agenda (home.js camadas) ──
  '🔴 Eventos': { en: '🔴 Events', es: '🔴 Eventos' },
  '📰 Artigos': { en: '📰 Articles', es: '📰 Artículos' },
  '📝 Posts (Duda)': { en: '📝 Posts (Duda)', es: '📝 Posts (Duda)' },
  '💶 MDF/Deadlines': { en: '💶 MDF/Deadlines', es: '💶 MDF/Deadlines' },
  '🎉 Datas': { en: '🎉 Dates', es: '🎉 Fechas' },
  // ── Área (area.html section titles) ──
  '🎯 Dashboard de metas': { en: '🎯 Goals dashboard', es: '🎯 Panel de metas' },
  '🔧 Ferramentas': { en: '🔧 Tools', es: '🔧 Herramientas' },
  '📊 Números': { en: '📊 Numbers', es: '📊 Números' },
  '📁 Projetos': { en: '📁 Projects', es: '📁 Proyectos' },
  '🚀 Workflows · disparar no Cowork': { en: '🚀 Workflows · trigger in Cowork', es: '🚀 Workflows · disparar en Cowork' },
  'agente da área →': { en: 'area agent →', es: 'agente del área →' },
  'Carregando módulo…': { en: 'Loading module…', es: 'Cargando módulo…' },
  // ── Status metas ──
  '✅ meta batida': { en: '✅ goal hit', es: '✅ meta alcanzada' },
  '⏳ pendente': { en: '⏳ pending', es: '⏳ pendiente' },
  'pendente': { en: 'pending', es: 'pendiente' },
  'meta batida': { en: 'goal hit', es: 'meta alcanzada' },
  // ── Ideias (mural) ──
  'Mural de Ideias de Marketing': { en: 'Marketing Ideas Wall', es: 'Muro de Ideas de Marketing' },
  '🌈 Todas': { en: '🌈 All', es: '🌈 Todas' },
  '📝 Conteúdo': { en: '📝 Content', es: '📝 Contenido' },
  '📣 Campanha': { en: '📣 Campaign', es: '📣 Campaña' },
  '🎪 Evento': { en: '🎪 Event', es: '🎪 Evento' },
  '🛠️ Produto': { en: '🛠️ Product', es: '🛠️ Producto' },
