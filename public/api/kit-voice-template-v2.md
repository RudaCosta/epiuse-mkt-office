...
>
> **Como usar:** cola este arquivo INTEIRO · troca os `{{campos}}` por dados reais · cola no [claude.ai](https://claude.ai/new) dizendo *"renderiza como artifact"* · Claude.ai gera o HTML do kit · salva PDF dentro do artifact.
