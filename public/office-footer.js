...
let OFFICE_FOOTER_VERSION = '0.56.1';
...
const OFFICE_VERSION_HISTORY = [
  ...
  { ver: '0.56.1', date: '21/jun/2026', label: 'Correção do Layout de 3 Colunas no Raccoon Studio (mockup vertical: controles na esquerda, 340px).', path: null, status: 'current' },
