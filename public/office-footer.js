...
const OFFICE_VERSION_HISTORY = [
  // ─── SPRINT 47 · Tema global EPI-USE/Atlas + Raccoon Redesign (22/jun/2026) ───
  { ver: '0.56.2', date: '22/jun/2026', label: 'Integração de Funcionalidades e Interatividade no Raccoon Studio (views, reviewer API, word count, settings/integrations stubs).', path: null, status: 'current' },
