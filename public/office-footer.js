...
let OFFICE_FOOTER_VERSION = '0.53.6';
...
const OFFICE_VERSION_HISTORY = [
  ...
  { ver: '0.53.6', date: '19/jun/2026', label: 'SPRINT 46 — Adicionados botões de cópia HTML (WorkControl) e Texto Limpo, além de dica para colagem no CMS.', path: null, status: 'current' },
