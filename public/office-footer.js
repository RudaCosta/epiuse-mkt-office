...
let OFFICE_FOOTER_VERSION = '0.53.5';
...
const OFFICE_VERSION_HISTORY = [
  ...
  { ver: '0.53.5', date: '19/jun/2026', label: 'SPRINT 46 — Integração da revisão colada ao Pipeline Editorial do Raccoon e consolidação do tema Aurora como padrão do Office.', path: null, status: 'current' },
