...
| 3 | **Gabrielle Senne** | Field Marketing | eventos presenciais, MDF, ativações |
...
| **Gabrielle Senne** | Field Marketing & Eventos | assumiu a área em set/2026; e-mail @epiuse e aniversário a cadastrar |
...
1. **Field Marketing trocou de dona** — Gabrielle Senne assumiu em set/2026. Telas e exports antigos podem citar ocupantes anteriores; ao cadastrar, usar role `field`.
...
```json
{
  "team": [
    ...
    { "id": "gabrielle", "name": "Gabrielle Senne",    "role": "Field Marketing · Eventos & MDF" },
